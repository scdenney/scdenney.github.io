...
<p class="page-inline-summary">Increasingly, my research relies on building research corpora from archival and other hard-to-use sources, combining OCR, vision-language models, and large language models to work with bodies of text that were previously difficult to analyze. Additionally, a maintaion a portfolio of applied research that examines innovation policy, entrepreneurship, and the digital economy.
