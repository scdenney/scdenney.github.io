...
I develop and maintain open educational resources for computational text analysis and quantitative research methods. These include curated datasets, instructional materials, and AI-assisted methodology tools designed to support students and researchers.

<div class="project-card">
<h3>NLP Corpora for Korean Studies</h3>

<p class="project-meta">
<a href="https://github.com/scdenney/nlp_corpora">
<svg height="16" width="16" viewBox="0 0 16 16" style="vertical-align: text-bottom; margin-right: 4px;"><path fill="currentColor" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path></svg>
GitHub Repository
</a>
</p>
...
<div>
<p>A curated collection of text corpora for digital humanities and computational social science research on Korea. The repository includes datasets ranging from historical magazines and textbooks to political speeches and social media content, all prepared for use in teaching and research.</p>
</div>
</details>
</div>
...
<p class="project-meta">
<a href="https://github.com/scdenney/open-science-skills">
<svg height="16" width="16" viewBox="0 0 16 16" style="vertical-align: text-bottom; margin-right: 4px;"><path fill="currentColor" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path></svg>
GitHub Repository
</a>
</p>
...
<summary>About This Resource</summary>
<div>
<p>A library of <a href="https://docs.anthropic.com/en/docs/claude-code/skills">Claude Code skills</a> for experimental social science methodology. 11 skills cover the research pipeline from hypothesis generation through final reporting — including conjoint design and diagnostics, survey design, list experiments, cross-national design, topic modeling, LLM text classification, pre-registration, and methods reporting. Install as a plugin or select individual skills. All guidance is grounded in 65+ published methodology sources.</p>
</div>
</details>
</div>
